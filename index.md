# prefviz ![prefviz hex sticker](reference/figures/prefviz-sticker.png)
...
![](reference/figures/README-dop-bar-1.png)
...
![](reference/figures/README-pairwise-heatmap-1.png)
...
![](reference/figures/README-ternary-2d-1.png)
...
to prepare the data for an animated tour through the high-dimensional
...
![](reference/figures/README-ternary-hd-1.png)![](reference/figures/README-ternary-hd-2.png)
...
- [`vignette("transform_raw_data", package = "prefviz")`](https://numbats.github.io/prefviz/articles/transform_raw_data.md) -
  ...
  to transform raw data to be ready for visualisation
- [`vignette("draw_ternary_plot", package = "prefviz")`](https://numbats.github.io/prefviz/articles/draw_ternary_plot.md) -
  ...
  `get_tern_*()`, and `tourr`.
- [`vignette("add_ordered_path", package = "prefviz")`](https://numbats.github.io/prefviz/articles/add_ordered_path.md) -
  how to add ordered paths to your ternary plots to trace how preference
